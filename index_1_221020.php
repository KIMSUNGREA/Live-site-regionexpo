				    ...
				    <div class="swiper-slide slide-2">
				    	...
				    	<div class="section-wrap">
							<div class="text-wrap">
								...
								<div class="buttons">
									<a href="/page/s1/s1.php" class="btn bdr medium">윤석열 정부 지역균형발전 국정과제</a>
								</div>
							</div>
						</div>
				    </div> <!-- // swiper-slide 2 -->
				    	...
				    	<div class="section-wrap">
							<div class="text-wrap">
								...
								<div class="buttons">
									...
									<a href="/page/s4/s11.php" class="btn bdr medium">청년·기업 행사 바로 가기</a>
									<a href="/page/s4/s21.php" class="btn bdr medium">국민참여 행사 바로 가기</a>
								</div>
							</div>
						</div>
				    </div> <!-- // swiper-slide 3 -->
						...
						<div class="item-wrap">
							...
							<div class="item">
								...
								<div class="video large">
								    <iframe width="560" height="349" src="https://www.youtube.com/embed/AqGaZaeQMZ4" frameborder="0" allowfullscreen></iframe>
								</div>
					...
					<div class="cont-wrap">
						...
						<div class="item-wrap">
							...
							<ul class="item-list col-4">
								<li class="with"><a href="/page/s2/s2.php">
									<h4>지방시대관</h4>
									<div class="img-wrap img-pc"><img src="../@resource/images/common/img_exhibit.jpg" alt=""></div>
									<div class="img-wrap img-mo" style="background-image: url(../@resource/images/common/img_exhibit_mo.jpg);"></div>
								...
								<li><div>
									<h4>시·도전시관</h4>
									<div class="img-wrap img-pc"><img src="../@resource/images/common/img_exhibit_2.jpg" alt=""></div>
									<a href="/page/s2/s3.php" class="img-wrap img-mo" style="background-image: url(../@resource/images/common/img_exhibit_2_mo.jpg);"></a>
									<ul class="place-list">
								...
								<li class="with"><a href="/page/s2/s4.php">
									<h4>특별관</h4>
									<div class="img-wrap img-pc"><img src="../@resource/images/common/img_exhibit_3.jpg" alt=""></div>
									<div class="img-wrap img-mo" style="background-image: url(../@resource/images/common/img_exhibit_3_mo.jpg);"></div>
									<div class="hover-text">
										기업, 청년,<br> 지역혁신가, 주민 등 대상맞춤형 특별 전시를 운영합니다
										<strong>특별관</strong>
									</div>
								</a></li>
								<li class="join">
									<div class="item">
										...
										<ul class="link-wrap">
											<li><a href="/page/s4/s11.php#cont">희망이음취업캠프</a></li>
											<li><a href="/page/s4/s12.php#cont">희망이음-부울경 취업박람회</a></li>
											<li><a href="/page/s4/s13.php#cont">청년마을 행사</a></li>
											<li><a href="/page/s4/s14.php#cont">혁신도시 투자유치설명회</a></li>
										</ul>
									</div>
									<div class="item">
										<h5>국민참여행사</h5>
										...
										<ul class="link-wrap">
											<li><a href="/page/s4/s21.php#cont">대한민국 로컬 대축전</a></li>
											<li><a href="/page/s4/s22.php#cont">고향사랑기부캠페인</a></li>
										</ul>
									</div>
								</li>
							</ul>
					...
					<div class="item-wrap">
						...
						<ul class="item-list col-1">
							...
							<li><a href="/page/s6/s3.php?cf=view&seq=<?php echo $_rf['seq'];?>">
								<!-- <div class="img-wrap"><img src="../@resource/images/@temp/img_586x266.jpg" alt=""></div> -->
