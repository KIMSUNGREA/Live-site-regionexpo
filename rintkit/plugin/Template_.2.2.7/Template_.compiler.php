...
/*---------------------------------------------------------------------------
 ...
 ----------------------------------------------------------------------------
  ...
  Copyright (C) 2003-2011 Hyeong-Gil Park
...
class Template_Compiler_
{
	...
	// parse template
		...
		$this->_save_result($cpl_path, $cpl_head, ' */ '.$plugins.$size_of_top_loop.'?>'.$nl.'<?php if (defined(\'RINTKIT\') === FALSE) { exit(\'잘못된 경로입니다.\');}?>'.$nl, $source);
