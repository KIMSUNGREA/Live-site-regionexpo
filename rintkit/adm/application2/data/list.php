	...
	<tbody>
		...
		?>
			<tr>
				...
				<td><p><a href="<?php echo $_url;?>/?sd=data&cf=view&seq=<?php echo $_l[$i]['seq'];?>"><?php echo $_l[$i]['comp_ceo'];?></a></p></td>
				<td><p><?php echo $_l[$i]['per_name'];?></p></td>
				<td><p><?php echo $_l[$i]['per_phone'];?></p></td>
