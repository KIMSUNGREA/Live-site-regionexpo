...
<div class="rt_bot_box">
	<h1>이용 안내</h1>
	<p><em>-</em>현재 <span class="rt_mint">IP 차단</span>설정을 사용 중입니다. 등록된 IP는 접근할 수 없습니다.</p>
	<p><em>-</em>IP 등록 시 <span class="rt_mint">IP 대역</span>으로 등록하시면 4번째 IP는 관계없이 3번째 IP까지만 체크합니다.</p>
</div>

<script src="assets/js/deny.controller.js" type="text/javascript"></script>
