...
function goDel(seq)
{
	if (seq) {
		...
		{
			$("#rt_ifrm").attr("src",rt_path['adm']+"/ipset/ipset/update.php?f=list_deny&delKey="+seq);
		}
	} else {
...
;(function($) {
	$(function() {
		...
		$("#stO").click(function (){
			$("#sel_O").html('');
			$("#sel_B").html('<input type="text" name="ip4" class="rt_input_txt rt_w40" maxlength="3" style="width:50px;">');
		});
