...
<div class="rt_left_ban_wrap clearfix">
		...
		if ($form_cnt > 0) {
			...
			<li class="rt_field_con clearfix">
				...
				<div class="rt_ico_wrap">
					<a href="<?php echo RTW_ADM;?>/app/?appcode=rtboard&sd=<?php echo $env->_get['sd'];?>&bcode=<?php echo $env->_get['bcode'];?>&seq=<?php echo $_fl[$m]['seq'];?>" title="수정"><img src="<?php echo $_def['path_assets'];?>/img/sawtooth_ico.png" alt="톱니" /></a>
	...
	<table class="rt_field_table mb10">
		...
		<tr>
			<th><p>CSS Class</p></th>
			<td>
				<span style="color:#CC3D3D;"><b>.rtboard-add-css-<?php echo $_f['seq'];?></b></span> (이 필드에 부여된 CSS Class 명입니다.)
			</td>
		</tr>
		<tr>
			<th><p>CSS 작성 예시</p></th>
			<td>
				<p style="line-height:20px;">
					.rtboard-add-css-<?php echo $_f['seq'];?>  {<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;font-size:12px;<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;padding:5px;<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;color:#999999;<br />
					}
...
<script src="<?=$_def['path_section']?>/js/rtboard.admin.field.js" type="text/javascript"></script>
