...
<table class="rt_data_table">
	...
	<tr id="tr-category-data" <?php if($_r['category_is']=="n"){?>style="display:none;"<?}?>>
		...
		<td colspan="3">
			...
			<p class="rt_brown rt_fln">글 분류를 공백없이 쉼표로 구분하여 입력해 주세요. ex) 구분1,구분2...</p>
		</td>
	</tr>
	<tr>
		<th><p>댓글 사용 여부</p></th>
	...
	<tr>
		...
		<th><p>웹에디터 사용 여부</p></th>
		<td>
			<p>
				<label><input type="radio" name="webeditor_is" value="y" <?php echo $webeditor_is_y;?>> 사용함</label>
				<label><input type="radio" name="webeditor_is" value="n" <?php echo $webeditor_is_n;?>> 사용안함</label>
			</p>
		</td>
	</tr>
	<tr>
		...
		<td colspan="3">
			<p>
				<label><input type="radio" name="assent_term_is" value="y" <?php echo $assent_term_is_y;?>> 사용함</label>
				<label><input type="radio" name="assent_term_is" value="n" <?php echo $assent_term_is_n;?>> 사용안함</label>
			</p>
		</td>
	</tr>
	<tr id="tr-term-data" <?if($_r['assent_term_is']=="n"){?>style="display:none;"<?}?>>
		<th><p>개인정보취급방침 내용</p></th>
		<td colspan="3">
			<textarea class="rt_input_txt" name="assent_term_txt"><?php echo rt_dbstr_decode($_r['assent_term_txt'])?></textarea>
		</td>
	</tr>
	</tbody>
</table>
...
<script src="<?php echo $_def['path_section'];?>/js/rtboard.theme.norm.conf.js" type="text/javascript"></script>
