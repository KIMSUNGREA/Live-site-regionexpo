...
function cmt_delete(seq) {
	...
	if (confirm("이 댓글을 삭제하시겠습니까?")) {
		$("#rt_ifrm").attr("src",rt_path['app']+"/theme/info/data/update.php?mode=cmt_delete&seq="+seq);
	}
}
...
;(function($) {
	$(function() {
		...
		$("#btn-list").click(function (){
			...
			location.href = rt_path['adm']+"/app/?appcode=rtboard&sd=theme-info-data&bcode="+bcode+"&pg="+pg+schurl;
		});
		...
		$("#btn-modify").click(function (){
			...
			location.href = rt_path['adm']+"/app/?appcode=rtboard&sd=theme-info-data&cf=form&bcode="+bcode+"&seq="+seq+"&pg="+pg+schurl;
		});
		...
		$("#btn-delete").click(function (){
			...
			if (confirm("이 글을 삭제하시겠습니까?")) {
				$("#rt_ifrm").attr("src",rt_path['app']+"/theme/info/data/update.php?mode=delete&bcode="+bcode+"&seq="+seq+"&pg="+pg+schurl);
			}
		});
