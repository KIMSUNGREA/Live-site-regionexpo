...
<colgroup>
	...
	<tr>
		...
		<td><p><?php echo ($r['reply_is'] == "y")?"답변완료":"답변대기"?></p></td>
	</tr>
	<?php if ($r['reply_is'] == "y") { ?>
	<tr>
		<th><p style="color:brown;">답변 내용</p></th>
		<td class="rt_substance"><p><?php echo $r['content_reply'];?></p></td>
	</tr>
	<?php } ?>
	<tr>
		<th><p style="color:brown;">답변 등록일</p></th>
		<td><p><?php echo $r['reply_date'];?></p></td>
	</tr>
	</tbody>
</table>
</form>
...
<div class="rt_button_wrap rt_tar mb25">
	...
	<a href="#;" id="btn-reply-form" class="rt_btn_orange">답글 설정</a>
