...
switch ($_def['func'])
{
	case "list"	:
		...
		$_list = $dbo->fetch_list("SELECT * FROM RT_PRODUCT_FORM_TPL ORDER BY ord ASC");
	break;
	...
	case "form"	:
		...
		$_r = $dbo->fetch("SELECT * FROM RT_PRODUCT_FORM_TPL WHERE seq='".$env->_get['seq']."'");
