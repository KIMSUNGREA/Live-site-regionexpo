...
<table class="rt_data_table">
	...
	<tbody>
		...
		<tr>
			<th><p>뎀플릿 데이터</p></th>
			<td>
				<textarea name="content" id="content" class="rt_input_txt required" style="height:350px;width:100%;" msg="템플릿 데이터를 입력해 주세요"><?php echo $_r['content'];?></textarea>
			</td>
		</tr>
	</tbody>
</table>
...
<div class="rt_bot_box">
	<h1>이용안내</h1>
	<p><em>-</em>템플릿은 <span class="rt_mint">반복되는 글쓰기</span>나 <span class="rt_mint">레이아웃이 있는 폼</span>을 이용하여 작성할 때 유용하게 사용됩니다. </p>
</div>
...
<script src="<?php echo $_def['path_section'];?>/js/product.admin.formtpl.js" type="text/javascript"></script>
