<?php /* Template_ 2.2.7 2017/03/11 00:47:06 /home/rintkit.com/new/app/rtmember/template/rtmember.email.findpw.html 000002930 */ ?>
...
<tr>
	<td style="padding: 45px 0 30px 0;">
		...
		<tbody>
		<tr>
			<td  align="center" valign="top" style="font-family: Gulim, dotum, Helvetica, Arial, sans-serif; color:#fff; letter-spacing:-1px; "><h1>패스워드 찾기</h1></td>
		</tr>
		<tr>
			<td style="color:#FFF; text-align:center; padding-bottom:10px"><h3><?php echo $TPL_VAR["회원명"]?>(<?php echo $TPL_VAR["아이디"]?>) <span>님의 임시 패스워드를 발급해 드립니다.</span></h3><h3>임시 패스워드 : <?php echo $TPL_VAR["임시패스워드"]?></h3></td>
		</tr>
		</tbody>
		</table>
	</td>
