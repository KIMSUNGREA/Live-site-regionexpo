...
<div class="rt_tem_code_wrap">
	...
	<ul class="rt_tem_code_con clearfix">
		<li class="rt_button_wrap">
			...
			<a href="#;" class="bth_b">LOGIN</a>
			<a href="#;" class="bth_b">STEP 1</a>
			<a href="#;" class="bth_b">STEP 2</a>
			<a href="#;" class="bth_b">STEP 3</a>
			<a href="#;" class="bth_b">MYPAGE<br />(MODIFY)</a>
		</li>
		<li class="rt_tem_code_box">
			<div class="rt_tem_tb_wrap">
				...
				<table class="rt_tem_tb">
					...
					<tr>
						<th><p>{page_join}</p></th>
						<td><p>회원가입 모듈이 설치된 페이지 위치(연동설정 탭에서 설정가능), ex)/page/s1/s1.php</p></td>
					</tr>
					<tr>
