...
.process ul {text-align: center; font-size:16px;}
...
<div class="content-primary">
    ...
    <section class="section-1">
       <div class="tabs w1200">
         <div class="inner">
            <a href="/page/s5/s2.php" class="active">2008</a>
            <a href="/page/s5/s21.php" class="">2009</a>
        </div>
     </div>
		<div class="title-wrap">
			<h2 class="title">2008 지역투자박람회</h2>
		</div>
                ...
                <div class="table_basic">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th>일시/장소</th>
                                <td><span>2008.7.3.~7.4 / 서울 COEX</span></td>
                                <td rowspan="4"><p class="tac photo"><img src="/@resource/images/@temp/s52_2008.png"></p></td>
                            </tr>
                            <tr>
                                <th>슬 로 건</th>
                                <td><span class="blue" ><b>지역경제 르네상스, 지역투자로 열겠습니다</b></span></td>
                            </tr>
                            <tr>
                                <th>주 제</th>
							...
							<tr>
                                <th>추진 목적</th>
                                <td><span class="black_444" ><b>기업 입장에서 16개 시·도의 투자환경을 한 자리에서 일목요연하게 파악하고,<br>시·도 입장에서는 기업과 투자자들을 한꺼번에 맞아 투자 확대 기회 확보</b></span></td>
                            </tr>
							<tr>
                                <th>추진 체계</th>
                                <td colspan="2"> <p class="r_title">주 최</p><span>16개 시·도, 전경련, 대한상의, 무역협회, 중기중앙회</span><br>
                                       <p class="r_title">주 관</p><span>한국산업기술재단</span><br>

									   <p class="r_title">후 원</p><span>지식경제부, 행정안전부, 국토해양부, 국가균형발전위원회,<br>한국산업단지공단, 한국토지공사, KOTRA, AMCHAM,<br> EUCCK, SJC, 한국외국기업협회</span>
                                </td>
                            </tr>
							<tr>
                                <th>행사 특징</th>
                                <td colspan="2"><span style="color:#1e8dc5;"><b>시도의 경쟁적 투자유치 전시상담 37건, 21조여원의 투자유치 MOU 체결로 지역투자 활성화 계기 마련</b></span></td>
                            </tr>
                            <tr>
                                <th>주요 내용</th>
                                <td colspan="2"><span class="black_444" ><b>① 6개시도 투자환경과 지원제도 전시 및 상담을 위한 전시상담장 운영<br>
② 기초지역특화기업관, 지역기술기업투자유치관, 산업입지지원관 운영<br>
③ 37건의 MOU 체결식<br>
④ 16개 지자체 투자유치설명회 개최<br>
⑤ 테마별 투자유치설명회</b></span></td>
                            </tr>
                             <tr>
                                <th>행사 구성</th>
                                <td colspan="2">
...
- 광역지자체 전시·상담 부스 운영<br>
- 외국인투자 대상 투자설명회(일본·화상 등)<br>
- 투자유치를 통한 지역경제활성화 성공사례설명회<br>
- 지역투자 활성화 및 산업입지투자 세미나<br>
- 지역기술기반기업, 지역특화기업 투자설명회</p>
						                </div>
					                 </li>
            ...
            <h5 class="sv4-mtit pt50">미디어 콘텐츠 아카이빙</h5>
               ...
               <ul class="square_img_list pt50">
					<li class="">
						<p class="square_img"><img src="/@resource/images/2008/01.png"></p>
					</li>
                </ul>
