...
.process {width: 90%;position: relative;display: inline-block;float: left;}
    ...
    <section class="section-1">
       <div class="tabs w1200">
         <div class="inner">
            ...
            <a href="/page/s5/s11.php" class="active">2005</a>
            <a href="/page/s5/s12.php" class="">2006</a>
            <a href="/page/s5/s13.php" class="">2007</a>
        </div>
     </div>
		<div class="title-wrap">
			<h2 class="title">2005 지역혁신박람회(제2회 대한민국 지역혁신박람회)</h2>
		</div>
                ...
                <div class="table_basic">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th>일시/장소</th>
                                <td><span>2005.10.5.~10.9 / 대구 EXCO</span></td>
                                <td rowspan="4"><p class="tac photo"><img src="/@resource/images/@temp/s51_2005.jpg"></p></td>
                            </tr>
                            <tr>
                                <th>슬 로 건</th>
                                <td><span class="blue" ><b>지역이 바뀌면 나라가 바뀝니다<br>Go! Region, Get Vision</b></span></td>
                            </tr>
                            <tr>
                                <th>주 제</th>
							...
							<tr>
                                <th>추진 목적</th>
                                <td><span class="black_444" ><b>국가균형발전위원회에서 국가균형발전시책에 대한<br>범국민적 이해를 제고하고 지역혁신의 성공적 추진</b></span></td>
                            </tr>
							<tr>
                                <th>추진 체계</th>
                                <td colspan="2"><p class="r_title">주 최</p><span>국가균형발전위원회, 산업자원부, 대구시, 경상북도</span><br>
                            ...
                            <tr>
                                <th>주요 내용</th>
                                <td colspan="2"><span class="black_444" ><b>① 5개 분야 지역혁신우수사례부분별 발표<br>
② 혁신도시, 클러스터정책 등 주요 정책별 컨퍼런스 개최<br>
③ 지역혁신관, 산학협력관, 혁신클러스터관 등 전시관 운영<br>
④ 체험수기, 창작물 분야 공모<br>
⑤ 체험, 먹거리장터 운영</b></span></td>
                            </tr>
                             <tr>
                                <th>행사 구성</th>
                                <td colspan="2">
                                ...
                                <div class="process">
                                   <ul class="tac">
					                   <li>
						                 <div class="txt_wrap">
							               <p class="num">개막행사</p>
							               <p class="txt lh15">개막식, 전시장오프닝, 환영리셉션</p>
						                </div>
					                 </li>
                                     <li>
						                 <div class="txt_wrap">
							               <p class="num">성공사례발표회</p>
							               <p class="txt lh15">지자체, 지역혁신체계구축, 대학, 중소기업, 연구지원기관</p>
						                </div>
					                 </li>
                                     <li style="background-color:#fdf7f3;">
						                 <div class="txt_wrap">
							               <p class="num">컨퍼런스</p>
							               <p class="txt lh15">국제컨퍼런스, 국내컨퍼런스(지역혁신협의회 총회, 지역혁신연구회 총회/세미나, 학술회의, 혁신클러스터 세미나, 혁신도시 심포지엄 등)</p>
						                </div>
					                 </li>
                                    </ul>
                                    <ul class="tac">
                                     <li>
						                 <div class="txt_wrap">
							               <p class="num">전시행사</p>
							               <p class="txt lh15">산학협력관, 지역혁신과, 혁신클러스터관, 혁신도시관, 체험관, 공모전 우수작 전시관 등</p>
						                </div>
					                 </li>
                                     <li>
						                 <div class="txt_wrap">
							               <p class="num">문화·이벤트행사</p>
							               <p class="txt lh15">개막축하특별공연, 지역특산한마당, 아마티스트 콘서트, 시도민 한마음 걷기대회 Young Festival 등</p>
						                </div>
					                 </li>
				                    </ul>
                                </div> 
            ...
            <h5 class="sv4-mtit pt50">미디어 콘텐츠 아카이빙</h5>
               ...
               <ul class="square_img_list pt50">
					<li class="">
						<p class="square_img"><img src="/@resource/images/2005/01.png"></p>
					</li>
