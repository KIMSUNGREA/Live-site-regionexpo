				    ...
				    <div class="swiper-slide slide-1">
				    	<div class="section-wrap">
							<div class="text-wrap">
								...
								<div class="buttons">
									<a href="javascript:void(0)" class="btn bdr medium">대한민국 지방시대 엑스포 소개</a>
								</div>
							</div>
						</div>
				    </div> <!-- // swiper-slide 1 -->
				    <div class="swiper-slide slide-2">
				    	<div class="section-wrap">
							<div class="text-wrap">
								...
								<div class="buttons">
									<a href="javascript:void(0)" class="btn bdr medium">윤석열 정부 지역균형발전 국정과제</a>
								</div>
							</div>
						</div>
				    </div> <!-- // swiper-slide 2 -->
				    <div class="swiper-slide slide-3">
				    	<div class="section-wrap">
							<div class="text-wrap">
								...
								<div class="buttons">
									<a href="javascript:void(0)" class="btn bdr medium">개막행사 바로 가기 </a>
									<a href="javascript:void(0)" class="btn bdr medium">청년·기업 행사 바로 가기</a>
									<a href="javascript:void(0)" class="btn bdr medium">국민참여 행사 바로 가기</a>
								</div>
							</div>
						</div>
				    </div> <!-- // swiper-slide 3 -->
						...
						<div class="item-wrap">
							...
							<div class="item">
								...
								<div class="video large">
								    <iframe width="560" height="349" src="https://www.youtube.com/embed/AmjAkqmifJ8" frameborder="0" allowfullscreen></iframe>
								</div>
